...
print("saving charge file as: " + SAVEFILENAME)

#FILE = 'pmt_waveforms001.csv'
PEAK_VOLTAGE = 0.080 # V ; peak value of the blip; estimate it
#dT = 2E-10 # s
dT = 4E-10 # s ; does this have to match the horizontal scale?
IMPEDANCE = 50 # Ohms
...
#                skip_frame = True
    ...
    np.savetxt(('{0}').format(SAVEFILENAME), charge) # adjusted file saving
#
