'''
  This script contains functions that will process ntuple root files

  Originally written by : T. Pershing
  Modified by : J. He
'''
...
class ROOTProcessor(object):
  ...
  def addROOTFile(self, rootfile, branches_to_get='all'):
    '''
      Opens the root ntuple file at the path given and append its data
      ...
      Input:
        ...
        branches_to_get [array]
          Array of data variables to load into the dictionary. Used to
